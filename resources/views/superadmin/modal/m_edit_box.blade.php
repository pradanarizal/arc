                ...
                <div class="modal-body">
                    ...
                    <form action="{{ '/box/' . $item->id_box }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="rak" id="rak" value="{{ $item->id_rak }}" hidden>

                            <label for="nama_box">Nama Box</label>
                            <input type="text" value="{{ $item->nama_box }}" class="form-control" id="nama_box"
                                name="nama_box" aria-describedby="emailHelp">
                        </div>
