@foreach ($kelengkapan_dokumen as $item)
    <div class="modal fade" id="edit_kelengkapan{{ $item->id_kel_dokumen }}" tabindex="-1"
        aria-labelledby="edit_kel_dokumen" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ '/kelengkapan/' . $item->id_kel_dokumen }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $item->nama_kel_dokumen }}" class="form-control"
                                id="kelengkapan" name="kelengkapan" aria-describedby="emailHelp">
                        </div>
