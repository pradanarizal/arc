            ...
            <div class="table-responsive">
                <div class="d-flex align-items-center justify-content-between mb-1 p-1">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <form action="/approval/pengembalian" method="GET"
                            class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                            <div class="input-group">
                                <input type="text" name="keyword" id="pengembalianSearch"
                ...
                <table class="table table-bordered" id="pengembalianSearch" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>No. Dok</th>
                ...
                <div>{{ $pengembalian->links('pagination::bootstrap-5') }}</div>
            </div>
        </div>
    </div>
