...
@foreach ($dokumen as $item)
    <div class="modal fade" id="pengembalian_dokumen{{$item->no_dokumen}}" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <form action="/input_pengembalian_dokumen/{{ $item->no_dokumen }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="text" class="form-control" id="nomor_dokumen" name="nomor_dokumen" value="{{ $item->no_dokumen }}" hidden>
