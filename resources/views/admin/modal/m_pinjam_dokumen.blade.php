<div class="modal fade" id="pinjam_dokumen" tabindex="-1" aria-labelledby="pinjam_dokumen" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <form action="/dokumen" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tgl_ambil" class="form-control" id="tgl_ambil" name="tgl_ambil"
                    ...
                    <div>
                        ...
                        <input type="tgl_kembali" class="form-control" id="tgl_kembali" name="tgl_kembali"
